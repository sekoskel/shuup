...
@pytest.mark.parametrize("form_id, field, value, expected_value, shop", [
    ...
    ("registration_settings", consts.SETTING_ALLOW_COMPANY_REGISTRATION, True, "unset", None),
    ("registration_settings", consts.SETTING_ALLOW_COMPANY_REGISTRATION, "", False, None)
])
